...
class guiCopilote:
    ...
    def __init__(self, neuronConfigFileRyley: str, neuronConfigFileSix: str, version: str):
        ...
        self.__language = CLanguageCopilote(resource_path("language/copilote/paroleCopilote.json"),
                                            resource_path("language/copilote/paroleSix.json"),
                                            resource_path("language/copilote/paroleRyley.json"),
                                              resource_path("fichierJSON/aideRyley.json"),
                                              resource_path("fichierJSON/firstBootCopilote.json"),
        ...
        if self.__windowsOS and not self.__linuxOS:
            ...
            self.__emplacementIcon = resource_path("asset/icon-macos.png")
