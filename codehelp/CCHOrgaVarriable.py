...
class CHOrgraVarriable:
    ...
    def bootOrganisateur(self):
        ...
        self.__screenOrganisateurVar.iconphoto(False,PhotoImage(file="asset/icon/codehelp/icon.png"))
    ...
    def __openDoc(self):
        if self.__docOpen == True :
            messagebox.showwarning("Document ouvert","Un document est encore ouvert fermer le avant d'ouvrir un autre")
        else :
            self.__file = filedialog.askopenfilename(defaultextension=".chov", filetypes=[("Fichier Codehelp Orga Var", ".chov")])
            if self.__file :
                self.__docOpen = True 
                ...
                messagebox.showwarning("Aucun document selectionner","Veuillez selectionner un document")

    def __newDoc(self):
        self.__file = filedialog.asksaveasfilename(defaultextension=".chov", filetypes=[("Fichier Codehelp Orga Var", ".chov")])
        if self.__file :
            ...
            messagebox.showwarning("Aucun document enregister","Veuillez enregister un document")
    ...
    def __closeDoc(self):
        if self.__docOpen == True :
            ...
            messagebox.showwarning("Aucun document ouvert","Aucun document n'est ouvert")
    ...
    def __addValeur(self):
        if self.__docOpen == True :
            ...
            if name and value and typeVar :
                ...
                messagebox.showwarning("Erreur ecriture","Veuillez entrer tout la valeur pour ajouter une varriable")
        else :
            messagebox.showwarning("Aucun document ouvert","Veuillez ouvrir un document")
    ...
    def __saveOnFile(self):
        if self.__docOpen == True :
            ...
            messagebox.showwarning("Imposible d'enregistrer","Aucun document ouvert")
    ...
    def __supprValeur(self):
        ...
        if valeur :
            ...
            messagebox.showwarning("Imposible de supprimer une varriable","Aucun varriable selectionner")
